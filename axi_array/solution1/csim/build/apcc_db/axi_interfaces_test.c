...
void axi_interfaces(signed int *, signed int *);


/* Global Variable Definitions and Initialization */
static signed int aesl_internal_main_OC_d_i[32] = { 10u, 20u, 30u, 40u, 50u, 60u, 70u, 80u, 11u, 21u, 31u, 41u, 51u, 61u, 71u, 81u, 12u, 22u, 32u, 42u, 52u, 62u, 72u, 82u, 13u, 23u, 33u, 43u, 53u, 63u, 73u, 83u };
...
signed int main(void) {
  ...
  signed int llvm_cbe_d_i[32];    /* Address-exposed local */
  static  unsigned long long aesl_llvm_cbe_d_o_count = 0;
  signed int llvm_cbe_d_o[32];    /* Address-exposed local */
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = bitcast [32 x i32]* %%d_i to i8*, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_2_count);
  llvm_cbe_tmp__1 = ( char *)(( char *)(&llvm_cbe_d_i));
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = call i8* @memcpy(i8* %%1, i8* bitcast ([32 x i32]* @aesl_internal_main.d_i to i8*), i64 128 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_3_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__1, ( char *)(( char *)(&aesl_internal_main_OC_d_i)), 128ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",128ull);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__2);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds [32 x i32]* %%d_o, i64 0, i64 0, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_8_count);
  llvm_cbe_tmp__3 = (signed int *)(&llvm_cbe_d_o[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 32
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds [32 x i32]* %%d_i, i64 0, i64 0, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_9_count);
  llvm_cbe_tmp__4 = (signed int *)(&llvm_cbe_d_i[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 32
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @axi_interfaces(i32* %%3, i32* %%4) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_10_count);
  axi_interfaces((signed int *)llvm_cbe_tmp__3, (signed int *)llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__17:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = phi i32 [ 0, %%0 ], [ %%14, %%7  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = getelementptr inbounds [32 x i32]* %%d_i, i64 0, i64 %%8, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_24_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = load i32* %%9, align 4, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_25_count);
  llvm_cbe_tmp__9 = (unsigned int )*llvm_cbe_tmp__8;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds [32 x i32]* %%d_o, i64 0, i64 %%8, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_26_count);
  llvm_cbe_tmp__10 = (signed int *)(&llvm_cbe_d_o[(((signed long long )llvm_cbe_tmp__7))
#ifdef AESL_BC_SIM
 % 32
#endif
]);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load i32* %%11, align 4, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_27_count);
  llvm_cbe_tmp__11 = (unsigned int )*llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%5, i8* getelementptr inbounds ([9 x i8]* @aesl_internal_.str3, i64 0, i64 0), i32 %%10, i32 %%12) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_28_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = add nsw i32 %%storemerge2, 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_29_count);
  llvm_cbe_tmp__13 = (unsigned int )((unsigned int )(llvm_cbe_storemerge2&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__18:
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = call i32 @fclose(%%struct._iobuf* %%5) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_36_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__14);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = call i32 bitcast (i32 (...)* @system to i32 (i8*)*)(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str4, i64 0, i64 0)) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_37_count);
  llvm_cbe_tmp__15 = (unsigned int )system(( char *)((&aesl_internal__OC_str4[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 45
#endif
])));
...
llvm_cbe_tmp__21:
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = phi i32 [ 0, %%20 ], [ 1, %%19  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_48_count);
